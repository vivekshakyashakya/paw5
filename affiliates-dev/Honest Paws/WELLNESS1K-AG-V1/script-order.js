$(document).ready(function(){
  ...
  var inputs = document.querySelectorAll("#form-order input, #form-order select");
  ...
  var product_string = getCookie("product_selected");
  var product = JSON.parse(product_string);
  //name,product_image,shipping_id,campaign_id,offer_id,quantity,unit_price,product_id
  $("#submit-button").click(function(event){
    ...
    if (!errors) {
      ...
      orderData.shipping_id = product.shipping_id;
      orderData.campaign_id = product.campaign_id;
