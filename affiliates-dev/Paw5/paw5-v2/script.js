    ...
    function handleFormSubmit(form, input) {
      ...
      if (!errors) {
        ...
        dataSend = {
          ...
          shipping_address1: $("#shipping_address").val() + " " + $("#shipping_suite").val(),
        ...
        if ($('#same_address').is(':checked')) {
          ...
          dataSend.billing_address1 = $("#billing_address").val() + " " + $("#billing_suite").val();
          ...
          dataSend.billing_phone = $("#billing_phone").val();
        }
        if(getCookie('c_o')) {
        ...
        $.ajax({
          ...
          success : function(order) {
            ...
            $('.shipping-suite').html(dataSend.shipping_suite);
            ...
            $('.mailing-suite').html(dataSend.billing_suite);
